...
import 'nixie_vfd_clock_widget.dart';
...
void main() {
  ...
  //  - A clock widget (in this case, [NixieClock])
  //  - A model (provided to you by [ClockModel])
  // For more information, see the flutter_clock_helper package.
  //
  // Your job is to edit [NixieClock], or replace it with your
  // own clock widget. (Look in nixie_vfd_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) =>
      NixieVFDClock(model: model, child: NixieVFDClockWidget())));
}
